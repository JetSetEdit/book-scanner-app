    ...
    <main className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="mb-16 text-center">
          <h1 className="font-serif text-4xl md:text-5xl font-medium tracking-tight text-slate-900 mb-4">
            How We Work
          </h1>
        ...
        {/* Process Flow */}
        <div className="mb-20">
          <h2 className="font-serif text-2xl text-slate-900 mb-8 text-center">Our Process</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-slate-900 mb-2 uppercase tracking-wider text-sm">Book Identification</h3>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-slate-900 mb-2 uppercase tracking-wider text-sm">Deep Research</h3>
                <p className="text-slate-600 leading-relaxed">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-slate-900 mb-2 uppercase tracking-wider text-sm">AI Analysis</h3>
                <p className="text-slate-600 leading-relaxed">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-slate-900 mb-2 uppercase tracking-wider text-sm">Verification & Prioritization</h3>
                <p className="text-slate-600 leading-relaxed">
        ...
        {/* Visual Flow Diagram */}
        <div className="mb-20 border-t-2 border-slate-200 pt-12">
          <h2 className="font-serif text-2xl text-slate-900 mb-8 text-center">The Flow</h2>
          <div className="relative">
            {/* Simple flow diagram */}
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
              <div className="flex flex-col items-center">
                <div className="w-20 h-20 rounded-lg bg-slate-100 flex items-center justify-center mb-3">
                  <BookOpen className="h-10 w-10 text-slate-600" />
                </div>
                <p className="text-xs font-bold uppercase tracking-wider text-slate-500">ISBN Scan</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-slate-500">Research</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs font-bold uppercase tracking-wider text-slate-500">Warnings</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Key Principles */}
        <div className="mb-20 border-t-2 border-slate-200 pt-12">
          <h2 className="font-serif text-2xl text-slate-900 mb-8 text-center">Our Principles</h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-3">
              <h3 className="font-bold text-slate-900 uppercase tracking-wider text-sm">Transparency First</h3>
            ...
            <div className="space-y-3">
              <h3 className="font-bold text-slate-900 uppercase tracking-wider text-sm">Author Authority</h3>
              <p className="text-slate-600 leading-relaxed text-sm">
            ...
            <div className="space-y-3">
              <h3 className="font-bold text-slate-900 uppercase tracking-wider text-sm">Multiple Verification</h3>
              <p className="text-slate-600 leading-relaxed text-sm">
            ...
            <div className="space-y-3">
              <h3 className="font-bold text-slate-900 uppercase tracking-wider text-sm">Subjective Severity</h3>
              <p className="text-slate-600 leading-relaxed text-sm">
        ...
        {/* What We Don't Share */}
        <div className="mb-12 border-t-2 border-slate-200 pt-12">
          <h2 className="font-serif text-2xl text-slate-900 mb-6 text-center">What You Can Verify</h2>
