...
interface BookSpineLogoProps extends React.SVGProps<SVGSVGElement> {
  className?: string
}

export const BookSpineLogo = React.memo(
  React.forwardRef<SVGSVGElement, BookSpineLogoProps>(
    ({ className, ...props }, ref) => (
    <svg
      ref={ref}
      id="Layer_2"
      ...
      viewBox="0 0 695.14 868.49"
      className={cn("transition-[fill,color] duration-300 ease-in-out", className)}
...
BookSpineLogo.displayName = "BookSpineLogo"
