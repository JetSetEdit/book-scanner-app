...
export function Footer() {
  return (
    <footer className="border-t border-slate-100 bg-slate-50/30 mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <p className="text-xs text-slate-400 text-center leading-relaxed max-w-2xl mx-auto mb-4">
          ...
          <div className="text-center">
            <Link href="/transparency" className="text-xs text-slate-400 hover:text-slate-600 transition-colors underline underline-offset-2">
              Learn how we work
            </Link>
          </div>
        </div>
