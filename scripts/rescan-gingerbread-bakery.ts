...
async function rescanGingerbreadBakery() {
  console.log('🔄 Re-scanning "The Gingerbread Bakery" with updated prompt\n')
  console.log('='.repeat(60))

  const isbn = '9780008728090'
  
  console.log(`\n📖 ISBN: ${isbn}`)
  console.log('🔄 Force refresh enabled - will fetch fresh description and re-analyze\n')
...
rescanGingerbreadBakery().catch(console.error)
