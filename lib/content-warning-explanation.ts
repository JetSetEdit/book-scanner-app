/**
 * User-facing copy for how content warnings are generated.
 * Kept in one place for reuse (e.g. book details, help, FAQ).
 */

/** Label for the expandable control that reveals the explanation. */
export const HOW_WE_GENERATE_LABEL = 'How we generate these'
