...
export function middleware(request: NextRequest) {
  ...
  if (country && country !== 'AU') {
    // Return a geo-blocked page with branding
    return new NextResponse(
      `<!DOCTYPE html>
      <html>
        <head>
          <title>Service Not Available - Subtext</title>
          <meta charset="utf-8">
        ...
        <body>
          <div class="container">
            <div class="logo-container">
              <svg class="logo-svg" viewBox="0 0 695.14 868.49" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                <g fill="currentColor">
                  ...
                  <polygon points="158.88 821.85 134.82 822.01 134.82 598.18 158.88 598.19 158.88 821.85"/>
                  ...
                  <polygon points="281.06 510.94 256.96 511.14 257 306.05 281.04 305.48 281.06 510.94"/>
            ...
            <div class="message">
              <p style="color: #6B6B6B; font-size: 0.9rem;">Thank you for your interest!</p>
            </div>
          </div>
        </body>
      </html>`,
